...
parser = argparse.ArgumentParser(
    description='Add all genes to inCREDBle annotation table.')
        ...
        if row['gene'] or None:
            ...
            if scaffold_obj:
                try:
                    ...
                    annotation_obj = None
                if annotation_obj:
                    print('gene '+row['gene']+' exists. skipping...')
                else:
                    obj = Annotation()
                    ...
                    obj.jbrowse_link = "https://resistome.cnag.cat/genomes/cre/browse/?loc=" + row['scaffold'] + '%3A' + row['start'] + '..' + row['end']
